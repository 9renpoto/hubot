...
[![Greenkeeper badge](https://badges.greenkeeper.io/9renpoto/hubot.svg)](https://greenkeeper.io/)
...
nyan is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running nyan Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start nyan locally by running:
...
Then you can interact with nyan by typing `nyan help`.

    nyan> nyan help
    nyan animate me <query> - The same thing as `image me`, except adds [snip]
    nyan help - Displays all of the help commands that nyan knows about.
    ...
